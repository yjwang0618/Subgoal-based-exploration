...
class MixedSquareExponential(CovarianceInterface):
    ...
    @staticmethod
    def make_default_hyperparameters(len_params):
        """Return a default set up hyperparameters given the dimension of the space."""
        return numpy.ones(len_params)
...
class MixedPolynomialMatern52(CovarianceInterface):
...
class PolynomialSquareExponential(CovarianceInterface):
...
class PolynomialMaternNu2p5(CovarianceInterface):

    r"""Implement the square exponential covariance function.

    .. Note:: comments are copied in :class:`moe.optimal_learning.python.python_version.covariance.PolynomialMaternNu2p5`.
...
class MaternNu1p5(CovarianceInterface):
...
class MaternNu2p5(CovarianceInterface):
