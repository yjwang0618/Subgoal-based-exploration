...
class MixedPolynomialMatern52 final : public CovarianceInterface {
 public:
  MixedPolynomialMatern52(int dim, int num_IS, std::vector<double> hypers);
 ...
 private:
  explicit MixedPolynomialMatern52(const MixedPolynomialMatern52& source);
...
class PolynomialSquareExponential final : public CovarianceInterface {
 public:
  PolynomialSquareExponential(int dim, std::vector<double> hypers);
 ...
 private:
  explicit PolynomialSquareExponential(const PolynomialSquareExponential& source);
...
class PolynomialMaternNu2p5 final : public CovarianceInterface {
 public:
  PolynomialMaternNu2p5(int dim, std::vector<double> hypers);
 ...
 private:
  explicit PolynomialMaternNu2p5(const PolynomialMaternNu2p5& source);
