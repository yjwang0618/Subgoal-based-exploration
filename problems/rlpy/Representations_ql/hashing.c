...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "rlpy.Representations.hashing", 
        "sources": [
            "rlpy/Representations/hashing.pyx"
        ]
    }, 
    "module_name": "rlpy.Representations.hashing"
}
END: Cython Metadata */
...
#define __PYX_HAVE__rlpy__Representations__hashing
#define __PYX_HAVE_API__rlpy__Representations__hashing
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'rlpy.Representations.hashing' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static int __pyx_v_4rlpy_15Representations_7hashing_BIG_INT;
...
static long __pyx_f_4rlpy_15Representations_7hashing_hash(__Pyx_memviewslice, __Pyx_memviewslice, int, int); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn_npy_long = { "npy_long", NULL, sizeof(npy_long), { 0 }, 0, IS_UNSIGNED(npy_long) ? 'U' : 'I', IS_UNSIGNED(npy_long), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn_npy_longlong = { "npy_longlong", NULL, sizeof(npy_longlong), { 0 }, 0, IS_UNSIGNED(npy_longlong) ? 'U' : 'I', IS_UNSIGNED(npy_longlong), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_long = { "long", NULL, sizeof(long), { 0 }, 0, IS_UNSIGNED(long) ? 'U' : 'I', IS_UNSIGNED(long), 0 };
#define __Pyx_MODULE_NAME "rlpy.Representations.hashing"
extern int __pyx_module_is_main_rlpy__Representations__hashing;
int __pyx_module_is_main_rlpy__Representations__hashing = 0;

/* Implementation of 'rlpy.Representations.hashing' */
...
static const char __pyx_k_check_val[] = "check_val";
...
static const char __pyx_k_rlpy_Representations_hashing[] = "rlpy.Representations.hashing";
...
static const char __pyx_k_rlpy_Representations_hashing_pyx[] = "rlpy/Representations/hashing.pyx";
...
static PyObject *__pyx_n_s_check_val;
...
static PyObject *__pyx_n_s_rlpy_Representations_hashing;
static PyObject *__pyx_kp_s_rlpy_Representations_hashing_pyx;
...
static PyObject *__pyx_pf_4rlpy_15Representations_7hashing_physical_addr(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_A, PyArrayObject *__pyx_v_R, PyArrayObject *__pyx_v_counts, PyArrayObject *__pyx_v_check_data); /* proto */
...
/* "rlpy/Representations/hashing.pyx":9
...
static long __pyx_f_4rlpy_15Representations_7hashing_hash(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_R, int __pyx_v_increment, int __pyx_v_max) {
  int __pyx_v_i;
  int __pyx_v_n;
  int __pyx_v_l;
  int __pyx_v_ind;
  ...
  /* "rlpy/Representations/hashing.pyx":10
 * @cython.cdivision(True)
 * cdef long hash(long [:] A, long [:] R, int increment, int max):
 *     cdef int i = 0             # <<<<<<<<<<<<<<
 *     cdef int n = R.shape[0]
 ...
 */
  ...
  /* "rlpy/Representations/hashing.pyx":11
 * cdef long hash(long [:] A, long [:] R, int increment, int max):
 *     cdef int i = 0
 *     cdef int n = R.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int l = A.shape[0]
 ...
 */
  ...
  /* "rlpy/Representations/hashing.pyx":12
 *     cdef int i = 0
 *     cdef int n = R.shape[0]
 *     cdef int l = A.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int ind
 ...
 */
  ...
  /* "rlpy/Representations/hashing.pyx":14
 *     cdef int l = A.shape[0]
 *     cdef int ind
 *     cdef long result = 0             # <<<<<<<<<<<<<<
 *     for i in range(l):
 ...
 */
  ...
  /* "rlpy/Representations/hashing.pyx":15
 *     cdef int ind
 *     cdef long result = 0
 *     for i in range(l):             # <<<<<<<<<<<<<<
 *         ind = (A[i] + (increment * i)) % n
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "rlpy/Representations/hashing.pyx":16
 *     cdef long result = 0
 *     for i in range(l):
 *         ind = (A[i] + (increment * i)) % n             # <<<<<<<<<<<<<<
 *         result += R[ind]
 ...
 */
    ...
    __pyx_v_ind = (((*((long *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_4 * __pyx_v_A.strides[0]) ))) + (__pyx_v_increment * __pyx_v_i)) % __pyx_v_n);

    /* "rlpy/Representations/hashing.pyx":17
 *     for i in range(l):
 *         ind = (A[i] + (increment * i)) % n
 *         result += R[ind]             # <<<<<<<<<<<<<<
 *     result = result % max
 ...
 */
    ...
    __pyx_v_result = (__pyx_v_result + (*((long *) ( /* dim=0 */ (__pyx_v_R.data + __pyx_t_5 * __pyx_v_R.strides[0]) ))));
  }

  /* "rlpy/Representations/hashing.pyx":18
 *         ind = (A[i] + (increment * i)) % n
 *         result += R[ind]
 *     result = result % max             # <<<<<<<<<<<<<<
 *     return result
 * 
 */
  __pyx_v_result = (__pyx_v_result % __pyx_v_max);

  /* "rlpy/Representations/hashing.pyx":19
 *         result += R[ind]
 *     result = result % max
 *     return result             # <<<<<<<<<<<<<<
 * 
...
/* "rlpy/Representations/hashing.pyx":23
 * @cython.boundscheck(False)
 * @cython.cdivision(True)
...
/* Python wrapper */
static PyObject *__pyx_pw_4rlpy_15Representations_7hashing_1physical_addr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4rlpy_15Representations_7hashing_physical_addr[] = "\n    Map a virtual vector address A to a physical address i.e. the actual\n    feature number.\n    This is the actual hashing trick\n    ";
static PyMethodDef __pyx_mdef_4rlpy_15Representations_7hashing_1physical_addr = {"physical_addr", (PyCFunction)__pyx_pw_4rlpy_15Representations_7hashing_1physical_addr, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4rlpy_15Representations_7hashing_physical_addr};
static PyObject *__pyx_pw_4rlpy_15Representations_7hashing_1physical_addr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_A = 0;
  PyArrayObject *__pyx_v_R = 0;
  PyArrayObject *__pyx_v_counts = 0;
  PyArrayObject *__pyx_v_check_data = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("physical_addr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_A,&__pyx_n_s_R,&__pyx_n_s_counts,&__pyx_n_s_check_data,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_R)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("physical_addr", 1, 4, 4, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_counts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("physical_addr", 1, 4, 4, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_check_data)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("physical_addr", 1, 4, 4, 3); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "physical_addr") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    ...
    __pyx_v_check_data = ((PyArrayObject *)values[3]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("physical_addr", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("rlpy.Representations.hashing.physical_addr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_counts), __pyx_ptype_5numpy_ndarray, 1, "counts", 0))) __PYX_ERR(0, 25, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_check_data), __pyx_ptype_5numpy_ndarray, 1, "check_data", 0))) __PYX_ERR(0, 26, __pyx_L1_error)
  __pyx_r = __pyx_pf_4rlpy_15Representations_7hashing_physical_addr(__pyx_self, __pyx_v_A, __pyx_v_R, __pyx_v_counts, __pyx_v_check_data);
...
static PyObject *__pyx_pf_4rlpy_15Representations_7hashing_physical_addr(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_A, PyArrayObject *__pyx_v_R, PyArrayObject *__pyx_v_counts, PyArrayObject *__pyx_v_check_data) {
  __Pyx_memviewslice __pyx_v_A_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_R_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_h1;
  int __pyx_v_check_val;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_check_data;
  __Pyx_Buffer __pyx_pybuffer_check_data;
  ...
  __Pyx_RefNannySetupContext("physical_addr", 0);
  ...
  __pyx_pybuffer_check_data.pybuffer.buf = NULL;
  __pyx_pybuffer_check_data.refcount = 0;
  __pyx_pybuffernd_check_data.data = NULL;
  __pyx_pybuffernd_check_data.rcbuffer = &__pyx_pybuffer_check_data;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_A.rcbuffer->pybuffer, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn_npy_long, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 23, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_R.rcbuffer->pybuffer, (PyObject*)__pyx_v_R, &__Pyx_TypeInfo_nn_npy_long, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 23, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_counts.rcbuffer->pybuffer, (PyObject*)__pyx_v_counts, &__Pyx_TypeInfo_nn_npy_longlong, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 23, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_check_data.rcbuffer->pybuffer, (PyObject*)__pyx_v_check_data, &__Pyx_TypeInfo_nn_npy_longlong, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 23, __pyx_L1_error)
  }
  __pyx_pybuffernd_check_data.diminfo[0].strides = __pyx_pybuffernd_check_data.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_check_data.diminfo[0].shape = __pyx_pybuffernd_check_data.rcbuffer->pybuffer.shape[0];

  /* "rlpy/Representations/hashing.pyx":32
 *     This is the actual hashing trick
 *     """
 *     cdef long [:] A_view = A             # <<<<<<<<<<<<<<
 *     cdef long [:] R_view = R
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(((PyObject *)__pyx_v_A), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __pyx_v_A_view = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "rlpy/Representations/hashing.pyx":33
 *     """
 *     cdef long [:] A_view = A
 *     cdef long [:] R_view = R             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(((PyObject *)__pyx_v_R), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_v_R_view = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "rlpy/Representations/hashing.pyx":35
 *     cdef long [:] R_view = R
 * 
 *     cdef int h1 = hash(A_view, R_view, 449, R.shape[0])             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_h1 = __pyx_f_4rlpy_15Representations_7hashing_hash(__pyx_v_A_view, __pyx_v_R_view, 0x1C1, (__pyx_v_R->dimensions[0]));

  /* "rlpy/Representations/hashing.pyx":36
 * 
 *     cdef int h1 = hash(A_view, R_view, 449, R.shape[0])
 *     cdef int check_val = hash(A_view, R_view, 457, BIG_INT)             # <<<<<<<<<<<<<<
 * 
 *     if counts[h1] == 0:
 */
  __pyx_v_check_val = __pyx_f_4rlpy_15Representations_7hashing_hash(__pyx_v_A_view, __pyx_v_R_view, 0x1C9, __pyx_v_4rlpy_15Representations_7hashing_BIG_INT);

  /* "rlpy/Representations/hashing.pyx":38
 *     cdef int check_val = hash(A_view, R_view, 457, BIG_INT)
 * 
 *     if counts[h1] == 0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2 < 0) __pyx_t_2 += __pyx_pybuffernd_counts.diminfo[0].shape;
  __pyx_t_3 = (((*__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_counts.diminfo[0].strides)) == 0) != 0);
  if (__pyx_t_3) {

    /* "rlpy/Representations/hashing.pyx":39
 * 
 *     if counts[h1] == 0:
 *         check_data[h1] = check_val             # <<<<<<<<<<<<<<
 *         counts[h1] = counts[h1] + 1
 ...
 */
    ...
    if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_pybuffernd_check_data.diminfo[0].shape;
    *__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_check_data.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_check_data.diminfo[0].strides) = __pyx_v_check_val;

    /* "rlpy/Representations/hashing.pyx":40
 *     if counts[h1] == 0:
 *         check_data[h1] = check_val
 *         counts[h1] = counts[h1] + 1             # <<<<<<<<<<<<<<
 *         return h1, 0
 ...
 */
    ...
    if (__pyx_t_5 < 0) __pyx_t_5 += __pyx_pybuffernd_counts.diminfo[0].shape;
    __pyx_t_6 = __pyx_v_h1;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_pybuffernd_counts.diminfo[0].shape;
    *__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_counts.diminfo[0].strides) = ((*__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_counts.diminfo[0].strides)) + 1);

    /* "rlpy/Representations/hashing.pyx":41
 *         check_data[h1] = check_val
 *         counts[h1] = counts[h1] + 1
 *         return h1, 0             # <<<<<<<<<<<<<<
 *     elif np.all(check_val == check_data[h1]):
 ...
 */
    ...
    __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_h1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  ...
  /* "rlpy/Representations/hashing.pyx":42
 *         counts[h1] = counts[h1] + 1
 *         return h1, 0
 *     elif np.all(check_val == check_data[h1]):             # <<<<<<<<<<<<<<
 *         # clear hit, everything's fine
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_all); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_10 = __pyx_v_h1;
  if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_pybuffernd_check_data.diminfo[0].shape;
  __pyx_t_7 = __Pyx_PyBool_FromLong((__pyx_v_check_val == (*__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_check_data.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_check_data.diminfo[0].strides)))); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_11 = NULL;
  ...
  if (!__pyx_t_11) {
    __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_t_7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_GOTREF(__pyx_t_8);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_9)) {
      ...
      __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_9, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_9)) {
      PyObject *__pyx_temp[2] = {__pyx_t_11, __pyx_t_7};
      __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_9, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_7 = 0;
      __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_12, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_3 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_3 < 0)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (__pyx_t_3) {

    /* "rlpy/Representations/hashing.pyx":44
 *     elif np.all(check_val == check_data[h1]):
 *         # clear hit, everything's fine
 *         counts[h1] = counts[h1] + 1             # <<<<<<<<<<<<<<
 *         return h1, 0
 *     else:
 */
    __pyx_t_13 = __pyx_v_h1;
    if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_pybuffernd_counts.diminfo[0].shape;
    __pyx_t_14 = __pyx_v_h1;
    if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_pybuffernd_counts.diminfo[0].shape;
    *__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_counts.diminfo[0].strides) = ((*__Pyx_BufPtrStrided1d(npy_longlong *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_counts.diminfo[0].strides)) + 1);

    /* "rlpy/Representations/hashing.pyx":45
 *         # clear hit, everything's fine
 *         counts[h1] = counts[h1] + 1
 *         return h1, 0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_h1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
 ...
 */
  ...
  /* "rlpy/Representations/hashing.pyx":47
 *         return h1, 0
 *     else:
 *         return h1, 1             # <<<<<<<<<<<<<<
 * 
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_h1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_check_data.rcbuffer->pybuffer);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "rlpy.Representations.hashing.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "rlpy.Representations.hashing.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "rlpy.Representations.hashing.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "rlpy.Representations.hashing._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_check_val, __pyx_k_check_val, sizeof(__pyx_k_check_val), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_rlpy_Representations_hashing, __pyx_k_rlpy_Representations_hashing, sizeof(__pyx_k_rlpy_Representations_hashing), 0, 0, 1, 1},
  {&__pyx_kp_s_rlpy_Representations_hashing_pyx, __pyx_k_rlpy_Representations_hashing_pyx, sizeof(__pyx_k_rlpy_Representations_hashing_pyx), 0, 0, 1, 0},
 ...
 *                    np.ndarray[np.npy_longlong, ndim=1] counts,
 */
  __pyx_tuple__31 = PyTuple_Pack(8, __pyx_n_s_A, __pyx_n_s_R, __pyx_n_s_counts, __pyx_n_s_check_data, __pyx_n_s_A_view, __pyx_n_s_R_view, __pyx_n_s_h1, __pyx_n_s_check_val); if (unlikely(!__pyx_tuple__31)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__31);
  __Pyx_GIVEREF(__pyx_tuple__31);
  __pyx_codeobj__32 = (PyObject*)__Pyx_PyCode_New(4, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__31, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_rlpy_Representations_hashing_pyx, __pyx_n_s_physical_addr, 23, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__32)) __PYX_ERR(0, 23, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_rlpy__Representations__hashing) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "rlpy.Representations.hashing")) {
      if (unlikely(PyDict_SetItemString(modules, "rlpy.Representations.hashing", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "rlpy/Representations/hashing.pyx":2
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport cython
 * 
 */
  ...
  /* "rlpy/Representations/hashing.pyx":5
 * cimport cython
 * 
 ...
 * @cython.boundscheck(False)
 */
  __pyx_v_4rlpy_15Representations_7hashing_BIG_INT = 0x7FFFFFFF;
 ...
 *                    np.ndarray[np.npy_longlong, ndim=1] counts,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4rlpy_15Representations_7hashing_1physical_addr, NULL, __pyx_n_s_rlpy_Representations_hashing); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_physical_addr, __pyx_t_1) < 0) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "rlpy/Representations/hashing.pyx":1
 * cimport numpy as np             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport cython
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rlpy.Representations.hashing", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rlpy.Representations.hashing");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
