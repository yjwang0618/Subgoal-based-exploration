...
from problems.rlpy.Tools import perms
...
class RBF(Representation):
    ...
    def __init__(self, domain, weight_vec, num_rbfs=None, state_dimensions=None,
        ...
        super(RBF, self).__init__(domain, weight_vec, seed=seed)
