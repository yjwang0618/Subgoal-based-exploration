...
class MisoGridWorldItem(object):
    ...
    def __init__(self, replication_no, method_name, version, obj_func_idx, bucket, prob_name):
        ...
        self._bucket = bucket
        self._obj_func = [misoGridWorld_item(prob_name, version, mult=-1.0)]
...
class MisoGridWorldItemMkg(MisoGridWorldItem):
    ...
    def __init__(self, replication_no, version, obj_func_idx, bucket, prob_name):
        super(MisoGridWorldItemMkg, self).__init__(replication_no, "mkg", version, obj_func_idx, bucket, prob_name)
