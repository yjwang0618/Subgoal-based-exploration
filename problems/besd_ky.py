...
class BesdGridKey(object):
    ...
    def __init__(self, replication_no, method_name, obj_func_idx, bucket, prob_name):
        ...
        self._obj_func = [besdGridKey_(prob_name, mult=1.0)]
...
class BesdGridKeyMkg(BesdGridKey):

    def __init__(self, replication_no, obj_func_idx, bucket, prob_name):
        super(BesdGridKeyMkg, self).__init__(replication_no, "besd", obj_func_idx, bucket, prob_name)



class_collection = {
    "besd_ky": BesdGridKeyMkg,
}
