...
class BesdPuddle(object):
    ...
    def __init__(self, replication_no, method_name, obj_func_idx, bucket, prob_name):
        ...
        self._bucket = bucket
        self._obj_func = [besdPuddle_(prob_name, mult=-1.0)]
...
class BesdPuddleMkg(BesdPuddle):

    def __init__(self, replication_no, obj_func_idx, bucket, prob_name):
        super(BesdPuddleMkg, self).__init__(replication_no, "besd", obj_func_idx, bucket, prob_name)
        self._hist_data = None


class_collection = {
    "besd_pd": BesdPuddleMkg,
}
