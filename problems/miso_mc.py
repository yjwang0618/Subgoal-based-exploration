...
class MisoMountainCar(object):
    ...
    def __init__(self, replication_no, method_name, version, obj_func_idx, bucket, prob_name):
        ...
        self._bucket = bucket
        self._obj_func = [misoMountainCar_(prob_name, version, mult=1.0)]
...
class MisoMountainCarMkg(MisoMountainCar):

    def __init__(self, replication_no, version, obj_func_idx, bucket, prob_name):
        super(MisoMountainCarMkg, self).__init__(replication_no, "mkg", version, obj_func_idx, bucket, prob_name)
        self._hist_data = None


class_collection = {
    "miso_mc": MisoMountainCarMkg,
}
