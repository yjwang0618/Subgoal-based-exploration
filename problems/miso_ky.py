...
class MisoGridKey(object):
    ...
    def __init__(self, replication_no, method_name, version, obj_func_idx, bucket, prob_name):
        ...
        self._obj_func = [misoGridKey_(prob_name, version, mult=1.0)]
...
class MisoGridKeyMkg(MisoGridKey):

    def __init__(self, replication_no, version, obj_func_idx, bucket, prob_name):
        super(MisoGridKeyMkg, self).__init__(replication_no, "mkg", version, obj_func_idx, bucket, prob_name)



class_collection = {
    "miso_ky": MisoGridKeyMkg,
}
