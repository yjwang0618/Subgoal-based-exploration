...
class misoGridWorld_item(object):
    num_policy_checks = 1
    checks_per_policy = 1
    all_data = []
    all_data_raw = []
...
class MisoGridWorldItem(object):
    ...
    def __init__(self, replication_no, method_name, obj_func_idx, bucket, prob_name):
        ...
        self._bucket = bucket
        self._obj_func = [misoGridWorld_item(prob_name, mult=-1.0)]
...
class MisoGridWorldItemMkg(MisoGridWorldItem):

    def __init__(self, replication_no, obj_func_idx, bucket, prob_name):
        super(MisoGridWorldItemMkg, self).__init__(replication_no, "mkg", obj_func_idx, bucket, prob_name)



class_collection = {
    "miso_it": MisoGridWorldItemMkg,
}
