...
class misoGridWorld_(object):
    ...
    def __init__(self, prob_name, mult=1.0):
        ...
        if prob_name == 'gw10One1': 
            ...
            self._meanval, self.noise = 6.778, [0.009, 0.042, 0.137]
...
class MisoGridWorld(object):
    ...
    def __init__(self, replication_no, method_name, obj_func_idx, bucket, prob_name):
        ...
        self._obj_func = [misoGridWorld_(prob_name, mult=1.0)]
...
class MisoGridWorldMkg(MisoGridWorld):
    ...
    def __init__(self, replication_no, obj_func_idx, bucket, prob_name):
        super(MisoGridWorldMkg, self).__init__(replication_no, "mkg", obj_func_idx, bucket, prob_name)
